...
Wi-Fi точка доступа, с веб-сервером статичных сайтов, эмуляцией http/https страниц, а также работой с файлами карты памяти. Размещайте статичные веб-сайты, эмулируйте простую авторизацию, различные сервисы, простые API, обменивайтесь файлами на различных устройствах, в специальной Wi-Fi сети. Последняя версия: **6.1**.
